...
const WORKSPACES = [
  ...
  { id: 'tac',     name: 'Notify',    desc: 'Notify service monitoring',              chain: 'eth',       owner: 'priya@',    members: 4, convos: 89, updated: 'May 1',  pinned: false, activity: [8,7,9,10,8,11,9,10,12,11,9,10,12,13,11,12,10,11,13,12,10,11,9,10] },
  ...
  { id: 'TAC',     name: 'Relay',     desc: 'Relay service monitoring',               chain: 'starknet',  owner: 'priya@',    members: 4, convos: 14, updated: 'Apr 27', pinned: false, activity: [2,3,2,3,4,3,2,3,4,3,2,3,2,1,2,1,2,1,2,1,1,1,0,1] },
  ...
  { id: 'somnia',  name: 'Edge Gateway', desc: 'Edge Gateway production operations',                            chain: 'somnia',    owner: 'You',        members: 2, convos: 22, updated: 'May 1',  pinned: false, activity: [3,4,5,4,5,6,5,7,6,5,4,5,6,7,6,5,7,8,7,6,5,7,8,7] },
